...
cmd_rclone = 'rclone move /final LOkum: --drive-server-side-across-configs -v --include "/*.plot"'

# Rclone Config de belirlediğiniz ismi yazın.
rclone_dest_name = 'LOkum'  

# AutoRclone'un loglarını tuttuğu yer. Dosya yolunu değişmesi gerekiyorsa değiştirin.
script_log_file = r'/123/AutoRclone.log'
instance_lock_path = r'/123/AutoRclone.lock'
instance_config_path = r'/123/AutoRclone.conf'
